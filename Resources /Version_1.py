...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        countyVote_percentage = float(county_vote_count) / float(total_votes) * 100
        
         # 6d: Print the county results to the terminal.
        county_results = (
            f"{county_name}: {countyVote_percentage:.1f}%,({county_votes[county_name]:,})\n")
    ...
    txt_file.write("largest_vote_county")
